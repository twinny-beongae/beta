"use strict";(self["webpackChunktwinny_beongae"]=self["webpackChunktwinny_beongae"]||[]).push([[443],{9834:function(e,t,n){n.r(t),n.d(t,{default:function(){return Ol}});var i=n(3396);const s={class:"about"},r=(0,i._)("h1",null,"This is an about page",-1),o=[r];function a(e,t,n,r,a,h){return(0,i.wg)(),(0,i.iD)("div",s,o)}n(1703),n(2801),n(6699);
/**
 * @license
 ...
 * limitations under the License.
 */
const k="FirebaseError";class N extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name=k,Object.setPrototypeOf(this,N.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,P.prototype.create)}}class P{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const n=t[0]||{},i=`${this.service}/${e}`,s=this.errors[e],r=s?R(s,n):"Error",o=`${this.serviceName}: ${r} (${i}).`,a=new N(i,o,n);return a}}function R(e,t){return e.replace(x,((e,n)=>{const i=t[n];return null!=i?String(i):`<${n}?>`}))}const x=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const wt="firebase-heartbeat-database",bt=1,Et="firebase-heartbeat-store";let It=null;function Tt(){return It||(It=Se(wt,bt,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(Et)}}}).catch((e=>{throw ft.create("storage-open",{originalErrorMessage:e.message})}))),It}async function St(e){var t;try{const t=await Tt();return t.transaction(Et).objectStore(Et).get(Nt(e))}catch(n){throw ft.create("storage-get",{originalErrorMessage:null===(t=n)||void 0===t?void 0:t.message})}}async function kt(e,t){var n;try{const n=await Tt(),i=n.transaction(Et,"readwrite"),s=i.objectStore(Et);return await s.put(t,Nt(e)),i.done}catch(i){throw ft.create("storage-set",{originalErrorMessage:null===(n=i)||void 0===n?void 0:n.message})}}function Nt(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pt=1024,Rt=2592e6;class xt{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Ot(t),this._heartbeatsCachePromise=this._storage.read().then((e=>(this._heartbeatsCache=e,e)))}async triggerHeartbeat(){const e=this.container.getProvider("platform-logger").getImmediate(),t=e.getPlatformInfoString(),n=Dt();if(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate!==n&&!this._heartbeatsCache.heartbeats.some((e=>e.date===n)))return this._heartbeatsCache.heartbeats.push({date:n,agent:t}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter((e=>{const t=new Date(e.date).valueOf(),n=Date.now();return n-t<=Rt})),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";const e=Dt(),{heartbeatsToSend:t,unsentEntries:n}=At(this._heartbeatsCache.heartbeats),i=f(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function Dt(){const e=new Date;return e.toISOString().substring(0,10)}function At(e,t=Pt){const n=[];let i=e.slice();for(const s of e){const e=n.find((e=>e.agent===s.agent));if(e){if(e.dates.push(s.date),Mt(n)>t){e.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),Mt(n)>t){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}class Ot{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return!!T()&&S().then((()=>!0)).catch((()=>!1))}async read(){const e=await this._canUseIndexedDBPromise;if(e){const e=await St(this.app);return e||{heartbeats:[]}}return{heartbeats:[]}}async overwrite(e){var t;const n=await this._canUseIndexedDBPromise;if(n){const n=await this.read();return kt(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}}async add(e){var t;const n=await this._canUseIndexedDBPromise;if(n){const n=await this.read();return kt(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}}}function Mt(e){return f(JSON.stringify({version:2,heartbeats:e})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
Ct(Ft,qt,"app");const Ut="@firebase/database",Wt="0.13.1";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vt{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){null==t?delete this.cache_[e]:this.cache_[e]=t}get(e){return F(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Pn{constructor(e,t){this.appName_=e,this.appCheckProvider=t,this.appCheck=null===t||void 0===t?void 0:t.getImmediate({optional:!0}),this.appCheck||null===t||void 0===t||t.get().then((e=>this.appCheck=e))}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise(((t,n)=>{setTimeout((()=>{this.appCheck?this.getToken(e).then(t,n):t(null)}),0)}))}addTokenChangeListener(e){var t;null===(t=this.appCheckProvider)||void 0===t||t.get().then((t=>t.addTokenListener(e)))}notifyForInvalidToken(){on(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Dn="5",An="v",On="s",Mn="r",Ln="f",Fn=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,qn="ls",Un="p",Wn="ac",Bn="websocket",Hn="long_polling";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jn{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){this.pendingResponses[e]=t;while(this.pendingResponses[this.currentResponseNum]){const e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&Sn((()=>{this.onMessage_(e[t])}));if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ui extends qi{constructor(){super(["online"]),this.online_=!0,"undefined"===typeof window||"undefined"===typeof window.addEventListener||b()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}static getInstance(){return new Ui}getInitialEvent(e){return l("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wi=32,Bi=768;class Hi{constructor(e,t){if(void 0===t){this.pieces_=e.split("/");let t=0;for(let e=0;e<this.pieces_.length;e++)this.pieces_[e].length>0&&(this.pieces_[t]=this.pieces_[e],t++);this.pieces_.length=t,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)""!==this.pieces_[t]&&(e+="/"+this.pieces_[t]);return e||"/"}}function ji(){return new Hi("")}function Vi(e){return e.pieceNum_>=e.pieces_.length?null:e.pieces_[e.pieceNum_]}function zi(e){return e.pieces_.length-e.pieceNum_}function $i(e){let t=e.pieceNum_;return t<e.pieces_.length&&t++,new Hi(e.pieces_,t)}function Yi(e){return e.pieceNum_<e.pieces_.length?e.pieces_[e.pieces_.length-1]:null}function Gi(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}function Ki(e,t=0){return e.pieces_.slice(e.pieceNum_+t)}function Qi(e){if(e.pieceNum_>=e.pieces_.length)return null;const t=[];for(let n=e.pieceNum_;n<e.pieces_.length-1;n++)t.push(e.pieces_[n]);return new Hi(t,0)}function Ji(e,t){const n=[];for(let i=e.pieceNum_;i<e.pieces_.length;i++)n.push(e.pieces_[i]);if(t instanceof Hi)for(let i=t.pieceNum_;i<t.pieces_.length;i++)n.push(t.pieces_[i]);else{const e=t.split("/");for(let t=0;t<e.length;t++)e[t].length>0&&n.push(e[t])}return new Hi(n,0)}function Xi(e){return e.pieceNum_>=e.pieces_.length}function Zi(e,t){const n=Vi(e),i=Vi(t);if(null===n)return t;if(n===i)return Zi($i(e),$i(t));throw new Error("INTERNAL ERROR: innerPath ("+t+") is not within outerPath ("+e+")")}function es(e,t){if(zi(e)!==zi(t))return!1;for(let n=e.pieceNum_,i=t.pieceNum_;n<=e.pieces_.length;n++,i++)if(e.pieces_[n]!==t.pieces_[i])return!1;return!0}function ts(e,t){let n=e.pieceNum_,i=t.pieceNum_;if(zi(e)>zi(t))return!1;while(n<e.pieces_.length){if(e.pieces_[n]!==t.pieces_[i])return!1;++n,++i}return!0}class ns{constructor(e,t){this.errorPrefix_=t,this.parts_=Ki(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let n=0;n<this.parts_.length;n++)this.byteLength_+=Y(this.parts_[n]);rs(this)}}function is(e,t){e.parts_.length>0&&(e.byteLength_+=1),e.parts_.push(t),e.byteLength_+=Y(t),rs(e)}function ss(e){const t=e.parts_.pop();e.byteLength_-=Y(t),e.parts_.length>0&&(e.byteLength_-=1)}function rs(e){if(e.byteLength_>Bi)throw new Error(e.errorPrefix_+"has a key path longer than "+Bi+" bytes ("+e.byteLength_+").");if(e.parts_.length>Wi)throw new Error(e.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Wi+") or object contains a cycle "+os(e))}function os(e){return 0===e.parts_.length?"":"in property '"+e.parts_.join(".")+"'"}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ss(e,t){return dn(e.name,t.name)}function ks(e,t){return dn(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ns;function Ps(e){Ns=e}Ts.EMPTY_NODE=new Is;const Rs=function(e){return"number"===typeof e?"number:"+yn(e):"string:"+e},xs=function(e){if(e.isLeafNode()){const t=e.val();l("string"===typeof t||"number"===typeof t||"object"===typeof t&&F(t,".sv"),"Priority must be a string or number.")}else l(e===Ns||e.isEmpty(),"priority of unexpected type.");l(e===Ns||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let Ds,As,Os;class Ms{constructor(e,t=Ms.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,l(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),xs(this.priorityNode_)}static set __childrenNodeConstructor(e){Ds=e}static get __childrenNodeConstructor(){return Ds}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Ms(this.value_,e)}getImmediateChild(e){return".priority"===e?this.priorityNode_:Ms.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return Xi(e)?this:".priority"===Vi(e)?this.priorityNode_:Ms.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return".priority"===e?this.updatePriority(t):t.isEmpty()&&".priority"!==e?this:Ms.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const n=Vi(e);return null===n?t:t.isEmpty()&&".priority"!==n?this:(l(".priority"!==n||1===zi(e),".priority must be the last token in a path"),this.updateImmediateChild(n,Ms.__childrenNodeConstructor.EMPTY_NODE.updateChild($i(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(null===this.lazyHash_){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Rs(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",e+="number"===t?yn(this.value_):this.value_,this.lazyHash_=Qt(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Ms.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Ms.__childrenNodeConstructor?-1:(l(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,n=typeof this.value_,i=Ms.VALUE_TYPE_ORDER.indexOf(t),s=Ms.VALUE_TYPE_ORDER.indexOf(n);return l(i>=0,"Unknown leaf type: "+t),l(s>=0,"Unknown leaf type: "+n),i===s?"object"===n?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:s-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}}function Ls(e){As=e}function Fs(e){Os=e}Ms.VALUE_TYPE_ORDER=["object","boolean","number","string"];class qs extends ys{compare(e,t){const n=e.node.getPriority(),i=t.node.getPriority(),s=n.compareTo(i);return 0===s?dn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return ms.MIN}maxPost(){return new ms(un,new Ms("[PRIORITY-POST]",Os))}makePost(e,t){const n=As(e);return new ms(t,new Ms("[PRIORITY-POST]",n))}toString(){return".priority"}}const Us=new qs,Ws=Math.log(2);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let js;const Vs={};class zs{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return l(Vs&&Us,"ChildrenNode.ts has not been loaded"),js=js||new zs({".priority":Vs},{".priority":Us}),js}get(e){const t=q(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Ts?t:null}hasIndex(e){return F(this.indexSet_,e.toString())}addIndex(e,t){l(e!==ws,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(ms.Wrap);let r,o=s.getNext();while(o)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?Hs(n,e.getCompare()):Vs;const a=e.toString(),h=Object.assign({},this.indexSet_);h[a]=e;const c=Object.assign({},this.indexes_);return c[a]=r,new zs(c,h)}addToIndexes(e,t){const n=W(this.indexes_,((n,i)=>{const s=q(this.indexSet_,i);if(l(s,"Missing index implementation for "+i),n===Vs){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(ms.Wrap);let r=i.getNext();while(r)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),Hs(n,s.getCompare())}return Vs}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new ms(e.name,i))),s.insert(e,e.node)}}));return new zs(n,this.indexSet_)}removeFromIndexes(e,t){const n=W(this.indexes_,(n=>{if(n===Vs)return n;{const i=t.get(e.name);return i?n.remove(new ms(e.name,i)):n}}));return new zs(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $s;class Ys{constructor(e,t,n){this.children_=e,this.priorityNode_=t,this.indexMap_=n,this.lazyHash_=null,this.priorityNode_&&xs(this.priorityNode_),this.children_.isEmpty()&&l(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}static get EMPTY_NODE(){return $s||($s=new Ys(new Ts(ks),null,zs.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||$s}updatePriority(e){return this.children_.isEmpty()?this:new Ys(this.children_,e,this.indexMap_)}getImmediateChild(e){if(".priority"===e)return this.getPriority();{const t=this.children_.get(e);return null===t?$s:t}}getChild(e){const t=Vi(e);return null===t?this:this.getImmediateChild(t).getChild($i(e))}hasChild(e){return null!==this.children_.get(e)}updateImmediateChild(e,t){if(l(t,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(t);{const n=new ms(e,t);let i,s;t.isEmpty()?(i=this.children_.remove(e),s=this.indexMap_.removeFromIndexes(n,this.children_)):(i=this.children_.insert(e,t),s=this.indexMap_.addToIndexes(n,this.children_));const r=i.isEmpty()?$s:this.priorityNode_;return new Ys(i,r,s)}}updateChild(e,t){const n=Vi(e);if(null===n)return t;{l(".priority"!==Vi(e)||1===zi(e),".priority must be the last token in a path");const i=this.getImmediateChild(n).updateChild($i(e),t);return this.updateImmediateChild(n,i)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let n=0,i=0,s=!0;if(this.forEachChild(Us,((r,o)=>{t[r]=o.val(e),n++,s&&Ys.INTEGER_REGEXP_.test(r)?i=Math.max(i,Number(r)):s=!1})),!e&&s&&i<2*n){const e=[];for(const n in t)e[n]=t[n];return e}return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(null===this.lazyHash_){let e="";this.getPriority().isEmpty()||(e+="priority:"+Rs(this.getPriority().val())+":"),this.forEachChild(Us,((t,n)=>{const i=n.hash();""!==i&&(e+=":"+t+":"+i)})),this.lazyHash_=""===e?"":Qt(e)}return this.lazyHash_}getPredecessorChildName(e,t,n){const i=this.resolveIndex_(n);if(i){const n=i.getPredecessorKey(new ms(e,t));return n?n.name:null}return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.minKey();return e&&e.name}return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new ms(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.maxKey();return e&&e.name}return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new ms(t,this.children_.get(t)):null}forEachChild(e,t){const n=this.resolveIndex_(e);return n?n.inorderTraversal((e=>t(e.name,e.node))):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(e=>e));{const n=this.children_.getIteratorFrom(e.name,ms.Wrap);let i=n.peek();while(null!=i&&t.compare(i,e)<0)n.getNext(),i=n.peek();return n}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(e=>e));{const n=this.children_.getReverseIteratorFrom(e.name,ms.Wrap);let i=n.peek();while(null!=i&&t.compare(i,e)>0)n.getNext(),i=n.peek();return n}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===Ks?-1:0}withIndex(e){if(e===ws||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new Ys(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===ws||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){const e=this.getIterator(Us),n=t.getIterator(Us);let i=e.getNext(),s=n.getNext();while(i&&s){if(i.name!==s.name||!i.node.equals(s.node))return!1;i=e.getNext(),s=n.getNext()}return null===i&&null===s}return!1}return!1}}resolveIndex_(e){return e===ws?null:this.indexMap_.get(e.toString())}}Ys.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class Gs extends Ys{constructor(){super(new Ts(ks),Ys.EMPTY_NODE,zs.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return Ys.EMPTY_NODE}isEmpty(){return!1}}const Ks=new Gs;Object.defineProperties(ms,{MIN:{value:new ms(cn,Ys.EMPTY_NODE)},MAX:{value:new ms(un,Ks)}}),Cs.__EMPTY_NODE=Ys.EMPTY_NODE,Ms.__childrenNodeConstructor=Ys,Ps(Ks),Fs(Ks);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Qs=!0;function Js(e,t=null){if(null===e)return Ys.EMPTY_NODE;if("object"===typeof e&&".priority"in e&&(t=e[".priority"]),l(null===t||"string"===typeof t||"number"===typeof t||"object"===typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"===typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!==typeof e||".sv"in e){const n=e;return new Ms(n,Js(t))}if(e instanceof Array||!Qs){let n=Ys.EMPTY_NODE;return mn(e,((t,i)=>{if(F(e,t)&&"."!==t.substring(0,1)){const e=Js(i);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(Js(t))}{const n=[];let i=!1;const s=e;if(mn(s,((e,t)=>{if("."!==e.substring(0,1)){const s=Js(t);s.isEmpty()||(i=i||!s.getPriority().isEmpty(),n.push(new ms(e,s)))}})),0===n.length)return Ys.EMPTY_NODE;const r=Hs(n,Ss,(e=>e.name),ks);if(i){const e=Hs(n,Us.getCompare());return new Ys(r,Js(t),new zs({".priority":e},{".priority":Us}))}return new Ys(r,Js(t),zs.Default)}}Ls(Js);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Xs extends ys{constructor(e){super(),this.indexPath_=e,l(!Xi(e)&&".priority"!==Vi(e),"Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),s=n.compareTo(i);return 0===s?dn(e.name,t.name):s}makePost(e,t){const n=Js(e),i=Ys.EMPTY_NODE.updateChild(this.indexPath_,n);return new ms(t,i)}maxPost(){const e=Ys.EMPTY_NODE.updateChild(this.indexPath_,Ks);return new ms(un,e)}toString(){return Ki(this.indexPath_,0).join("/")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gr(){return{value:null,children:new Map}}function mr(e,t,n){if(Xi(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const i=Vi(t);e.children.has(i)||e.children.set(i,gr());const s=e.children.get(i);t=$i(t),mr(s,t,n)}}function yr(e,t,n){null!==e.value?n(t,e.value):vr(e,((e,i)=>{const s=new Hi(t.toString()+"/"+e);yr(i,s,n)}))}function vr(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wr=1e4,br=3e4,Er=3e5;class Ir{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Cr(e);const n=wr+(br-wr)*Math.random();Nn(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;mn(e,((e,i)=>{i>0&&F(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),Nn(this.reportStats_.bind(this),Math.floor(2*Math.random()*Er))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Tr;function Sr(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function kr(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Nr(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(function(e){e[e["OVERWRITE"]=0]="OVERWRITE",e[e["MERGE"]=1]="MERGE",e[e["ACK_USER_WRITE"]=2]="ACK_USER_WRITE",e[e["LISTEN_COMPLETE"]=3]="LISTEN_COMPLETE"})(Tr||(Tr={}));class Pr{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Tr.ACK_USER_WRITE,this.source=Sr()}operationForChild(e){if(Xi(this.path)){if(null!=this.affectedTree.value)return l(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Hi(e));return new Pr(ji(),t,this.revert)}}return l(Vi(this.path)===e,"operationForChild called for unrelated child."),new Pr($i(this.path),this.affectedTree,this.revert)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rr{constructor(e,t){this.source=e,this.path=t,this.type=Tr.LISTEN_COMPLETE}operationForChild(e){return Xi(this.path)?new Rr(this.source,ji()):new Rr(this.source,$i(this.path))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xr{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Tr.OVERWRITE}operationForChild(e){return Xi(this.path)?new xr(this.source,ji(),this.snap.getImmediateChild(e)):new xr(this.source,$i(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dr{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Tr.MERGE}operationForChild(e){if(Xi(this.path)){const t=this.children.subtree(new Hi(e));return t.isEmpty()?null:t.value?new xr(this.source,ji(),t.value):new Dr(this.source,ji(),t)}return l(Vi(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Dr(this.source,$i(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ur(e,t){return{eventCache:e,serverCache:t}}function Wr(e,t,n,i){return Ur(new Ar(t,n,i),e.serverCache)}function Br(e,t,n,i){return Ur(e.eventCache,new Ar(t,n,i))}function Hr(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function jr(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vr;const zr=()=>(Vr||(Vr=new Ts(pn)),Vr);class $r{constructor(e,t=zr()){this.value=e,this.children=t}static fromObject(e){let t=new $r(null);return mn(e,((e,n)=>{t=t.set(new Hi(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:ji(),value:this.value};if(Xi(e))return null;{const n=Vi(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue($i(e),t);if(null!=s){const e=Ji(new Hi(n),s.path);return{path:e,value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Xi(e))return this;{const t=Vi(e),n=this.children.get(t);return null!==n?n.subtree($i(e)):new $r(null)}}set(e,t){if(Xi(e))return new $r(t,this.children);{const n=Vi(e),i=this.children.get(n)||new $r(null),s=i.set($i(e),t),r=this.children.insert(n,s);return new $r(this.value,r)}}remove(e){if(Xi(e))return this.children.isEmpty()?new $r(null):new $r(null,this.children);{const t=Vi(e),n=this.children.get(t);if(n){const i=n.remove($i(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new $r(null):new $r(this.value,s)}return this}}get(e){if(Xi(e))return this.value;{const t=Vi(e),n=this.children.get(t);return n?n.get($i(e)):null}}setTree(e,t){if(Xi(e))return t;{const n=Vi(e),i=this.children.get(n)||new $r(null),s=i.setTree($i(e),t);let r;return r=s.isEmpty()?this.children.remove(n):this.children.insert(n,s),new $r(this.value,r)}}fold(e){return this.fold_(ji(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(Ji(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,ji(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Xi(e))return null;{const i=Vi(e),s=this.children.get(i);return s?s.findOnPath_($i(e),Ji(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,ji(),t)}foreachOnPath_(e,t,n){if(Xi(e))return this;{this.value&&n(t,this.value);const i=Vi(e),s=this.children.get(i);return s?s.foreachOnPath_($i(e),Ji(t,i),n):new $r(null)}}foreach(e){this.foreach_(ji(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(Ji(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr{constructor(e){this.writeTree_=e}static empty(){return new Yr(new $r(null))}}function Gr(e,t,n){if(Xi(t))return new Yr(new $r(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const s=i.path;let r=i.value;const o=Zi(s,t);return r=r.updateChild(o,n),new Yr(e.writeTree_.set(s,r))}{const i=new $r(n),s=e.writeTree_.setTree(t,i);return new Yr(s)}}}function Kr(e,t,n){let i=e;return mn(n,((e,n)=>{i=Gr(i,Ji(t,e),n)})),i}function Qr(e,t){if(Xi(t))return Yr.empty();{const n=e.writeTree_.setTree(t,new $r(null));return new Yr(n)}}function Jr(e,t){return null!=Xr(e,t)}function Xr(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Zi(n.path,t)):null}function Zr(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Us,((e,n)=>{t.push(new ms(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new ms(e,n.value))})),t}function eo(e,t){if(Xi(t))return e;{const n=Xr(e,t);return new Yr(null!=n?new $r(n):e.writeTree_.subtree(t))}}function to(e){return e.writeTree_.isEmpty()}function no(e,t){return io(ji(),e.writeTree_,t)}function io(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,s)=>{".priority"===t?(l(null!==s.value,"Priority writes must always be leaf nodes"),i=s.value):n=io(Ji(e,t),s,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(Ji(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Do(e){return{filter:e}}function Ao(e,t){l(t.eventCache.getNode().isIndexed(e.filter.getIndex()),"Event snap not indexed"),l(t.serverCache.getNode().isIndexed(e.filter.getIndex()),"Server snap not indexed")}function Oo(e,t,n,i,s){const r=new No;let o,a;if(n.type===Tr.OVERWRITE){const h=n;h.source.fromUser?o=qo(e,t,h.path,h.snap,i,s,r):(l(h.source.fromServer,"Unknown source."),a=h.source.tagged||t.serverCache.isFiltered()&&!Xi(h.path),o=Fo(e,t,h.path,h.snap,i,s,a,r))}else if(n.type===Tr.MERGE){const h=n;h.source.fromUser?o=Wo(e,t,h.path,h.children,i,s,r):(l(h.source.fromServer,"Unknown source."),a=h.source.tagged||t.serverCache.isFiltered(),o=Ho(e,t,h.path,h.children,i,s,a,r))}else if(n.type===Tr.ACK_USER_WRITE){const a=n;o=a.revert?zo(e,t,a.path,i,s,r):jo(e,t,a.path,a.affectedTree,i,s,r)}else{if(n.type!==Tr.LISTEN_COMPLETE)throw c("Unknown operation type: "+n.type);o=Vo(e,t,n.path,i,r)}const h=r.getChanges();return Mo(t,o,h),{viewCache:o,changes:h}}function Mo(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=Hr(e);(n.length>0||!e.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(nr(Hr(t)))}}function Lo(e,t,n,i,s,r){const o=t.eventCache;if(null!=Eo(i,n))return t;{let a,h;if(Xi(n))if(l(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=jr(t),s=n instanceof Ys?n:Ys.EMPTY_NODE,o=wo(i,s);a=e.filter.updateFullNode(t.eventCache.getNode(),o,r)}else{const n=Co(i,jr(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,r)}else{const c=Vi(n);if(".priority"===c){l(1===zi(n),"Can't have a priority with additional path components");const s=o.getNode();h=t.serverCache.getNode();const r=bo(i,n,s,h);a=null!=r?e.filter.updatePriority(s,r):o.getNode()}else{const l=$i(n);let u;if(o.isCompleteForChild(c)){h=t.serverCache.getNode();const e=bo(i,n,o.getNode(),h);u=null!=e?o.getNode().getImmediateChild(c).updateChild(l,e):o.getNode().getImmediateChild(c)}else u=To(i,c,t.serverCache);a=null!=u?e.filter.updateChild(o.getNode(),c,u,l,s,r):o.getNode()}}return Wr(t,a,o.isFullyInitialized()||Xi(n),e.filter.filtersNodes())}}function Fo(e,t,n,i,s,r,o,a){const h=t.serverCache;let l;const c=o?e.filter:e.filter.getIndexedFilter();if(Xi(n))l=c.updateFullNode(h.getNode(),i,null);else if(c.filtersNodes()&&!h.isFiltered()){const e=h.getNode().updateChild(n,i);l=c.updateFullNode(h.getNode(),e,null)}else{const e=Vi(n);if(!h.isCompleteForPath(n)&&zi(n)>1)return t;const s=$i(n),r=h.getNode().getImmediateChild(e),o=r.updateChild(s,i);l=".priority"===e?c.updatePriority(h.getNode(),o):c.updateChild(h.getNode(),e,o,s,Ro,null)}const u=Br(t,l,h.isFullyInitialized()||Xi(n),c.filtersNodes()),d=new xo(s,u,r);return Lo(e,u,n,s,d,a)}function qo(e,t,n,i,s,r,o){const a=t.eventCache;let h,l;const c=new xo(s,t,r);if(Xi(n))l=e.filter.updateFullNode(t.eventCache.getNode(),i,o),h=Wr(t,l,!0,e.filter.filtersNodes());else{const s=Vi(n);if(".priority"===s)l=e.filter.updatePriority(t.eventCache.getNode(),i),h=Wr(t,l,a.isFullyInitialized(),a.isFiltered());else{const r=$i(n),l=a.getNode().getImmediateChild(s);let u;if(Xi(r))u=i;else{const e=c.getCompleteChild(s);u=null!=e?".priority"===Yi(r)&&e.getChild(Qi(r)).isEmpty()?e:e.updateChild(r,i):Ys.EMPTY_NODE}if(l.equals(u))h=t;else{const n=e.filter.updateChild(a.getNode(),s,u,r,c,o);h=Wr(t,n,a.isFullyInitialized(),e.filter.filtersNodes())}}}return h}function Uo(e,t){return e.eventCache.isCompleteForChild(t)}function Wo(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,h)=>{const l=Ji(n,i);Uo(t,Vi(l))&&(a=qo(e,a,l,h,s,r,o))})),i.foreach(((i,h)=>{const l=Ji(n,i);Uo(t,Vi(l))||(a=qo(e,a,l,h,s,r,o))})),a}function Bo(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function Ho(e,t,n,i,s,r,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let h,l=t;h=Xi(n)?i:new $r(null).setTree(n,i);const c=t.serverCache.getNode();return h.children.inorderTraversal(((n,i)=>{if(c.hasChild(n)){const h=t.serverCache.getNode().getImmediateChild(n),c=Bo(e,h,i);l=Fo(e,l,new Hi(n),c,s,r,o,a)}})),h.children.inorderTraversal(((n,i)=>{const h=!t.serverCache.isCompleteForChild(n)&&void 0===i.value;if(!c.hasChild(n)&&!h){const h=t.serverCache.getNode().getImmediateChild(n),c=Bo(e,h,i);l=Fo(e,l,new Hi(n),c,s,r,o,a)}})),l}function jo(e,t,n,i,s,r,o){if(null!=Eo(s,n))return t;const a=t.serverCache.isFiltered(),h=t.serverCache;if(null!=i.value){if(Xi(n)&&h.isFullyInitialized()||h.isCompleteForPath(n))return Fo(e,t,n,h.getNode().getChild(n),s,r,a,o);if(Xi(n)){let i=new $r(null);return h.getNode().forEachChild(ws,((e,t)=>{i=i.set(new Hi(e),t)})),Ho(e,t,n,i,s,r,a,o)}return t}{let l=new $r(null);return i.foreach(((e,t)=>{const i=Ji(n,e);h.isCompleteForPath(i)&&(l=l.set(e,h.getNode().getChild(i)))})),Ho(e,t,n,l,s,r,a,o)}}function Vo(e,t,n,i,s){const r=t.serverCache,o=Br(t,r.getNode(),r.isFullyInitialized()||Xi(n),r.isFiltered());return Lo(e,o,n,i,Ro,s)}function zo(e,t,n,i,s,r){let o;if(null!=Eo(i,n))return t;{const a=new xo(i,t,s),h=t.eventCache.getNode();let c;if(Xi(n)||".priority"===Vi(n)){let n;if(t.serverCache.isFullyInitialized())n=Co(i,jr(t));else{const e=t.serverCache.getNode();l(e instanceof Ys,"serverChildren would be complete if leaf node"),n=wo(i,e)}c=e.filter.updateFullNode(h,n,r)}else{const s=Vi(n);let l=To(i,s,t.serverCache);null==l&&t.serverCache.isCompleteForChild(s)&&(l=h.getImmediateChild(s)),c=null!=l?e.filter.updateChild(h,s,l,$i(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(h,s,Ys.EMPTY_NODE,$i(n),a,r):h,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Co(i,jr(t)),o.isLeafNode()&&(c=e.filter.updateFullNode(c,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=Eo(i,ji()),Wr(t,c,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ma(e){l(!na,"__referenceConstructor has already been defined"),na=e}function ya(){return l(na,"Reference.ts has not been loaded"),na}let va=1;class Ca{constructor(e){this.listenProvider_=e,this.syncPointTree_=new $r(null),this.pendingWriteTree_=vo(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function wa(e,t,n,i,s){return ro(e.pendingWriteTree_,t,n,i,s),s?Da(e,new xr(Sr(),t,n)):[]}function ba(e,t,n=!1){const i=oo(e.pendingWriteTree_,t),s=ao(e.pendingWriteTree_,t);if(s){let t=new $r(null);return null!=i.snap?t=t.set(ji(),!0):mn(i.children,(e=>{t=t.set(new Hi(e),!0)})),Da(e,new Pr(i.path,t,n))}return[]}function Ea(e,t,n){return Da(e,new xr(kr(),t,n))}function Ia(e,t,n){const i=$r.fromObject(n);return Da(e,new Dr(kr(),t,i))}function Ta(e,t){return Da(e,new Rr(kr(),t))}function Sa(e,t,n){const i=qa(e,n);if(i){const n=Ua(i),s=n.path,r=n.queryId,o=Zi(s,t),a=new Rr(Nr(r),o);return Wa(e,s,a)}return[]}function ka(e,t,n,i){const s=t._path,r=e.syncPointTree_.get(s);let o=[];if(r&&("default"===t._queryIdentifier||_a(r,t))){const a=ca(r,t,n,i);oa(r)&&(e.syncPointTree_=e.syncPointTree_.remove(s));const h=a.removed;o=a.events;const l=-1!==h.findIndex((e=>e._queryParams.loadsAllData())),c=e.syncPointTree_.findOnPath(s,((e,t)=>fa(t)));if(l&&!c){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=Ba(t);for(let t=0;t<n.length;++t){const i=n[t],s=i.query,r=Ma(e,i);e.listenProvider_.startListening(Ha(s),La(e,s),r.hashFn,r.onComplete)}}}if(!c&&h.length>0&&!i)if(l){const n=null;e.listenProvider_.stopListening(Ha(t),n)}else h.forEach((t=>{const n=e.queryToTagMap.get(Fa(t));e.listenProvider_.stopListening(Ha(t),n)}));ja(e,h)}return o}function Na(e,t,n,i){const s=qa(e,i);if(null!=s){const i=Ua(s),r=i.path,o=i.queryId,a=Zi(r,t),h=new xr(Nr(o),a,n);return Wa(e,r,h)}return[]}function Pa(e,t,n,i){const s=qa(e,i);if(s){const i=Ua(s),r=i.path,o=i.queryId,a=Zi(r,t),h=$r.fromObject(n),l=new Dr(Nr(o),a,h);return Wa(e,r,l)}return[]}function Ra(e,t,n){const i=t._path;let s=null,r=!1;e.syncPointTree_.foreachOnPath(i,((e,t)=>{const n=Zi(e,i);s=s||da(t,n),r=r||fa(t)}));let o,a=e.syncPointTree_.get(i);if(a?(r=r||fa(a),s=s||da(a,ji())):(a=new ia,e.syncPointTree_=e.syncPointTree_.set(i,a)),null!=s)o=!0;else{o=!1,s=Ys.EMPTY_NODE;const t=e.syncPointTree_.subtree(i);t.foreachChild(((e,t)=>{const n=da(t,ji());n&&(s=s.updateImmediateChild(e,n))}))}const h=_a(a,t);if(!h&&!t._queryParams.loadsAllData()){const n=Fa(t);l(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=Va();e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}const c=so(e.pendingWriteTree_,i);let u=la(a,t,n,c,s,o);if(!h&&!r){const n=pa(a,t);u=u.concat(za(e,t,n))}return u}function xa(e,t,n){const i=!0,s=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Zi(e,t),s=da(n,i);if(s)return s}));return po(s,t,r,n,i)}function Da(e,t){return Aa(t,e.syncPointTree_,null,so(e.pendingWriteTree_,ji()))}function Aa(e,t,n,i){if(Xi(e.path))return Oa(e,t,n,i);{const s=t.get(ji());null==n&&null!=s&&(n=da(s,ji()));let r=[];const o=Vi(e.path),a=e.operationForChild(o),h=t.children.get(o);if(h&&a){const e=n?n.getImmediateChild(o):null,t=So(i,o);r=r.concat(Aa(a,h,e,t))}return s&&(r=r.concat(aa(s,e,i,n))),r}}function Oa(e,t,n,i){const s=t.get(ji());null==n&&null!=s&&(n=da(s,ji()));let r=[];return t.children.inorderTraversal(((t,s)=>{const o=n?n.getImmediateChild(t):null,a=So(i,t),h=e.operationForChild(t);h&&(r=r.concat(Oa(h,s,o,a)))})),s&&(r=r.concat(aa(s,e,i,n))),r}function Ma(e,t){const n=t.query,i=La(e,n);return{hashFn:()=>{const e=Yo(t)||Ys.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return i?Sa(e,n._path,i):Ta(e,n._path);{const i=wn(t,n);return ka(e,n,null,i)}}}}function La(e,t){const n=Fa(t);return e.queryToTagMap.get(n)}function Fa(e){return e._path.toString()+"$"+e._queryIdentifier}function qa(e,t){return e.tagToQueryMap.get(t)}function Ua(e){const t=e.indexOf("$");return l(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Hi(e.substr(0,t))}}function Wa(e,t,n){const i=e.syncPointTree_.get(t);l(i,"Missing sync point for query tag that we're tracking");const s=so(e.pendingWriteTree_,t);return aa(i,n,s,null)}function Ba(e){return e.fold(((e,t,n)=>{if(t&&fa(t)){const e=ga(t);return[e]}{let e=[];return t&&(e=ua(t)),mn(n,((t,n)=>{e=e.concat(n)})),e}}))}function Ha(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(ya())(e._repo,e._path):e}function ja(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=Fa(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}function Va(){return va++}function za(e,t,n){const i=t._path,s=La(e,t),r=Ma(e,n),o=e.listenProvider_.startListening(Ha(t),s,r.hashFn,r.onComplete),a=e.syncPointTree_.subtree(i);if(s)l(!fa(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!Xi(e)&&t&&fa(t))return[ga(t).query];{let e=[];return t&&(e=e.concat(ua(t).map((e=>e.query)))),mn(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(Ha(i),La(e,i))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $a{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new $a(t)}node(){return this.node_}}class Ya{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=Ji(this.path_,e);return new Ya(this.syncTree_,t)}node(){return xa(this.syncTree_,this.path_)}}const Ga=function(e){return e=e||{},e["timestamp"]=e["timestamp"]||(new Date).getTime(),e},Ka=function(e,t,n){return e&&"object"===typeof e?(l(".sv"in e,"Unexpected leaf node or priority contents"),"string"===typeof e[".sv"]?Qa(e[".sv"],t,n):"object"===typeof e[".sv"]?Ja(e[".sv"],t):void l(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Qa=function(e,t,n){switch(e){case"timestamp":return n["timestamp"];default:l(!1,"Unexpected server value: "+e)}},Ja=function(e,t,n){e.hasOwnProperty("increment")||l(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const i=e["increment"];"number"!==typeof i&&l(!1,"Unexpected increment value: "+i);const s=t.node();if(l(null!==s&&"undefined"!==typeof s,"Expected ChildrenNode.EMPTY_NODE for nulls"),!s.isLeafNode())return i;const r=s,o=r.getValue();return"number"!==typeof o?i:o+i},Xa=function(e,t,n,i){return eh(t,new Ya(n,e),i)},Za=function(e,t,n){return eh(e,new $a(t),n)};function eh(e,t,n){const i=e.getPriority().val(),s=Ka(i,t.getImmediateChild(".priority"),n);let r;if(e.isLeafNode()){const i=e,r=Ka(i.getValue(),t,n);return r!==i.getValue()||s!==i.getPriority().val()?new Ms(r,Js(s)):e}{const i=e;return r=i,s!==i.getPriority().val()&&(r=r.updatePriority(new Ms(s))),i.forEachChild(Us,((e,i)=>{const s=eh(i,t.getImmediateChild(e),n);s!==i&&(r=r.updateImmediateChild(e,s))})),r}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Eh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Ih(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||es(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Th(e,t,n){Ih(e,n),kh(e,(e=>es(e,t)))}function Sh(e,t,n){Ih(e,n),kh(e,(e=>ts(e,t)||ts(t,e)))}function kh(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){const r=s.path;t(r)?(Nh(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Nh(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Xt&&tn("event: "+n.toString()),Sn(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ph="repo_interrupt",Rh=25;class xh{constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Eh,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=gr(),this.transactionQueueTree_=new th,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Dh(e,t,n){if(e.stats_=Kn(e.repoInfo_),e.forceRestClient_||kn())e.server_=new _r(e.repoInfo_,((t,n,i,s)=>{Mh(e,t,n,i,s)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>Lh(e,!0)),0);else{if("undefined"!==typeof n&&null!==n){if("object"!==typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{A(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}e.persistentConnection_=new gs(e.repoInfo_,t,((t,n,i,s)=>{Mh(e,t,n,i,s)}),(t=>{Lh(e,t)}),(t=>{Fh(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=Qn(e.repoInfo_,(()=>new Ir(e.stats_,e.server_))),e.infoData_=new fr,e.infoSyncTree_=new Ca({startListening:(t,n,i,s)=>{let r=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(r=Ea(e.infoSyncTree_,t._path,o),setTimeout((()=>{s("ok")}),0)),r},stopListening:()=>{}}),qh(e,"connected",!1),e.serverSyncTree_=new Ca({startListening:(t,n,i,s)=>(e.server_.listen(t,i,n,((n,i)=>{const r=s(n,i);Sh(e.eventQueue_,t._path,r)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function Ah(e){const t=e.infoData_.getNode(new Hi(".info/serverTimeOffset")),n=t.val()||0;return(new Date).getTime()+n}function Oh(e){return Ga({timestamp:Ah(e)})}function Mh(e,t,n,i,s){e.dataUpdateCount++;const r=new Hi(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(s)if(i){const t=W(n,(e=>Js(e)));o=Pa(e.serverSyncTree_,r,t,s)}else{const t=Js(n);o=Na(e.serverSyncTree_,r,t,s)}else if(i){const t=W(n,(e=>Js(e)));o=Ia(e.serverSyncTree_,r,t)}else{const t=Js(n);o=Ea(e.serverSyncTree_,r,t)}let a=r;o.length>0&&(a=Gh(e,r)),Sh(e.eventQueue_,a,o)}function Lh(e,t){qh(e,"connected",t),!1===t&&Wh(e)}function Fh(e,t){mn(t,((t,n)=>{qh(e,t,n)}))}function qh(e,t,n){const i=new Hi("/.info/"+t),s=Js(n);e.infoData_.updateSnapshot(i,s);const r=Ea(e.infoSyncTree_,i,s);Sh(e.eventQueue_,i,r)}function Uh(e){return e.nextWriteId_++}function Wh(e){Vh(e,"onDisconnectEvents");const t=Oh(e),n=gr();yr(e.onDisconnect_,ji(),((i,s)=>{const r=Xa(i,s,e.serverSyncTree_,t);mr(n,i,r)}));let i=[];yr(n,ji(),((t,n)=>{i=i.concat(Ea(e.serverSyncTree_,t,n));const s=el(e,t);Gh(e,s)})),e.onDisconnect_=gr(),Sh(e.eventQueue_,ji(),i)}function Bh(e,t,n){let i;i=".info"===Vi(t._path)?Ra(e.infoSyncTree_,t,n):Ra(e.serverSyncTree_,t,n),Th(e.eventQueue_,t._path,i)}function Hh(e,t,n){let i;i=".info"===Vi(t._path)?ka(e.infoSyncTree_,t,n):ka(e.serverSyncTree_,t,n),Th(e.eventQueue_,t._path,i)}function jh(e){e.persistentConnection_&&e.persistentConnection_.interrupt(Ph)}function Vh(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),tn(n,...t)}function zh(e,t,n){return xa(e.serverSyncTree_,t,n)||Ys.EMPTY_NODE}function $h(e,t=e.transactionQueueTree_){if(t||Zh(e,t),ih(t)){const n=Jh(e,t);l(n.length>0,"Sending zero length transaction queue");const i=n.every((e=>0===e.status));i&&Yh(e,ch(t),n)}else rh(t)&&ah(t,(t=>{$h(e,t)}))}function Yh(e,t,n){const i=n.map((e=>e.currentWriteId)),s=zh(e,t,i);let r=s;const o=s.hash();for(let c=0;c<n.length;c++){const e=n[c];l(0===e.status,"tryToSendTransactionQueue_: items in queue should all be run."),e.status=1,e.retryCount++;const i=Zi(t,e.path);r=r.updateChild(i,e.currentOutputSnapshotRaw)}const a=r.val(!0),h=t;e.server_.put(h.toString(),a,(i=>{Vh(e,"transaction put response",{path:h.toString(),status:i});let s=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,s=s.concat(ba(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();Zh(e,nh(e.transactionQueueTree_,t)),$h(e,e.transactionQueueTree_),Sh(e.eventQueue_,t,s);for(let e=0;e<i.length;e++)Sn(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{on("transaction at "+h.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}Gh(e,t)}}),o)}function Gh(e,t){const n=Qh(e,t),i=ch(n),s=Jh(e,n);return Kh(e,s,i),i}function Kh(e,t,n){if(0===t.length)return;const i=[];let s=[];const r=t.filter((e=>0===e.status)),o=r.map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const r=t[a],h=Zi(n,r.path);let c,u=!1;if(l(null!==h,"rerunTransactionsUnderNode_: relativePath should not be null."),4===r.status)u=!0,c=r.abortReason,s=s.concat(ba(e.serverSyncTree_,r.currentWriteId,!0));else if(0===r.status)if(r.retryCount>=Rh)u=!0,c="maxretry",s=s.concat(ba(e.serverSyncTree_,r.currentWriteId,!0));else{const n=zh(e,r.path,o);r.currentInputSnapshot=n;const i=t[a].update(n.val());if(void 0!==i){vh("transaction failed: Data returned ",i,r.path);let t=Js(i);const a="object"===typeof i&&null!=i&&F(i,".priority");a||(t=t.updatePriority(n.getPriority()));const h=r.currentWriteId,l=Oh(e),c=Za(t,n,l);r.currentOutputSnapshotRaw=t,r.currentOutputSnapshotResolved=c,r.currentWriteId=Uh(e),o.splice(o.indexOf(h),1),s=s.concat(wa(e.serverSyncTree_,r.path,c,r.currentWriteId,r.applyLocally)),s=s.concat(ba(e.serverSyncTree_,h,!0))}else u=!0,c="nodata",s=s.concat(ba(e.serverSyncTree_,r.currentWriteId,!0))}Sh(e.eventQueue_,n,s),s=[],u&&(t[a].status=2,function(e){setTimeout(e,Math.floor(0))}(t[a].unwatcher),t[a].onComplete&&("nodata"===c?i.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):i.push((()=>t[a].onComplete(new Error(c),!1,null)))))}Zh(e,e.transactionQueueTree_);for(let a=0;a<i.length;a++)Sn(i[a]);$h(e,e.transactionQueueTree_)}function Qh(e,t){let n,i=e.transactionQueueTree_;n=Vi(t);while(null!==n&&void 0===ih(i))i=nh(i,n),t=$i(t),n=Vi(t);return i}function Jh(e,t){const n=[];return Xh(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function Xh(e,t,n){const i=ih(t);if(i)for(let s=0;s<i.length;s++)n.push(i[s]);ah(t,(t=>{Xh(e,t,n)}))}function Zh(e,t){const n=ih(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,sh(t,n.length>0?n:void 0)}ah(t,(t=>{Zh(e,t)}))}function el(e,t){const n=ch(Qh(e,t)),i=nh(e.transactionQueueTree_,t);return lh(i,(t=>{tl(e,t)})),tl(e,i),hh(i,(t=>{tl(e,t)})),n}function tl(e,t){const n=ih(t);if(n){const i=[];let s=[],r=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(l(r===t-1,"All SENT items should be at beginning of queue."),r=t,n[t].status=3,n[t].abortReason="set"):(l(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),s=s.concat(ba(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===r?sh(t,void 0):n.length=r+1,Sh(e.eventQueue_,ch(t),s);for(let e=0;e<i.length;e++)Sn(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Sl(e){Ht(mt),dt(new K("database",((e,{instanceIdentifier:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return wl(n,i,s,t)}),"PUBLIC").setMultipleInstances(!0)),Ct(Ut,Wt,e),Ct(Ut,Wt,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */gs.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},gs.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};Sl();const kl={apiKey:{NODE_ENV:"production",BASE_URL:"/beta/"}.VUE_APP_FIREBASE_API_KET,authDomain:{NODE_ENV:"production",BASE_URL:"/beta/"}.VUE_APP_FIREBASE_AUTH_DOMAIN,databaseURL:"https://twinny-beongae-ea0a4-default-rtdb.firebaseio.com",projectId:{NODE_ENV:"production",BASE_URL:"/beta/"}.VUE_APP_FIREBASE_PROJECT_ID,storageBucket:{NODE_ENV:"production",BASE_URL:"/beta/"}.VUE_APP_FIREBASE_STORAGE_BUCKET,messagingSenderId:{NODE_ENV:"production",BASE_URL:"/beta/"}.VUE_APP_FIREBASE_MESSAGING_SENDER_ID,appId:{NODE_ENV:"production",BASE_URL:"/beta/"}.VUE_APP_FIREBASE_APP_ID,measurementId:{NODE_ENV:"production",BASE_URL:"/beta/"}.VUE_APP_FIREBASE_MEASUREMENT_ID},Nl=yt(kl),Pl=Tl(Nl),Rl=dl(Pl,"rooms/room1/appointment_time");ml(Rl,(e=>{console.log(e.val())}));var xl={name:"AboutView",components:{},date(){return{appointmentTime:1}},methods:{}},Dl=n(89);const Al=(0,Dl.Z)(xl,[["render",a]]);var Ol=Al}}]);
//# sourceMappingURL=about.4e9dcd9c.js.map